      ...
      child: Column(
        ...
        children: [
          ...
          _buildActionCard(
            ...
            isCompleted: status != OwnerOnboardingStatus.unknown && status != OwnerOnboardingStatus.draft,
            isActive: status == OwnerOnboardingStatus.unknown || status == OwnerOnboardingStatus.draft,
